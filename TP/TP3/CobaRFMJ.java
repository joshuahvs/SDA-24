    ...
    public static void main(String[] args) {
        ...
        for (int q = 0; q < Q; q++) {
            ...
            if (command == 'R') {
                ...
                // J [ID]
                // Sofita berandai-andai apakah dia bisa menemukan jarak terpendek yang
                // menyambungkan seluruh kota yang ada di Indonesia. Oleh karena itu, Sofita memulai
                // imajinasinya dengan menghubungkan seluruh kota dimulai dari kota dengan id ID.
                // Namun, Sofita ingin seluruh jalan yang terhubung langsung dengan kota tersebut
                // juga diperhitungkan dalam perhitungan jarak. Maka dari itu, cetak total jarak
                // terpendek yang menyambungkan seluruh kota di Indonesia dengan
                // memperhitungkan seluruh jalan yang terhubung langsung dengan kota ID.

                // • Keluaran dari perintah J:
                // Keluarkan total jarak terpendek yang menyambungkan seluruh kota dari
                // kota <ID> dengan memperhitungkan seluruh jalan yang terhubung langsung
                // dengan kota <ID>.

                // • Algoritma: Kruskal dengan Union-Find.
                // • Menggunakan MST (Minimum Spanning Tree) dengan algoritma Kruskal untuk menghitung biaya total MST, dengan tambahan “forced edges” yang melibatkan kota id.
                // • Keunggulan:
                // • Efisien (O(E log E)) untuk graf berbobot.
                // • Union-Find dengan path compression mempercepat operasi penyatuan dan pencarian (hampir O(1) per operasi).
            }
        }
