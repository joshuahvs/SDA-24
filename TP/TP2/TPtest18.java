...
public class TPtest18 {
            ...
            if (command == 'A'){
                ...
                do{
                    ...
                    if (jokiTeam != null && sofitaTeam.id == jokiTeam.id) {
                        ...
                        jokiTeam = getNearestTeamWithLowestPoints(teamList, sofitaTeam, jokiIndex);
                ...
                // out.println("sofita team id sesudah G = " + sofitaTeam.id);
            } 
            else if (command == 'V'){
    ...
    private static Team getNearestTeamWithLowestPoints(MyLinkedList<Team> teamList, Team excludeTeam, int jokiIndex) {
        int n = teamList.size();
        ...
        for (int idx : candidateIndices) {
            ...
            if (dist < minDistance) {
                ...
                // Tie-breaker: choose the team with the smaller ID
                if (teamList.get(idx).id < teamList.get(bestIndex).id) {
                    bestIndex = idx;
                }
            }
        }
    ...
    private static void eliminateTeam(Team team, MyLinkedList<Team> teamList, MyTreeMap<Integer, Team> teams, MyTreeMap<Integer, Object> participants) {
        // out.println("remove team  " + team.id);
